(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "core-js/modules/web.dom.iterable", "./isLike", "./cast", "./read"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("core-js/modules/web.dom.iterable"), require("./isLike"), require("./cast"), require("./read"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.webDom, global.isLike, global.cast, global.read);
    global.data = mod.exports;
  }
})(this, function (_exports, _webDom, _isLike, _cast, _read) {
  "use strict";
