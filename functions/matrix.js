(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./cast", "./isLike", "./reduce", "./nice", "./enumerable"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./cast"), require("./isLike"), require("./reduce"), require("./nice"), require("./enumerable"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.cast, global.isLike, global.reduce, global.nice, global.enumerable);
    global.matrix = mod.exports;
  }
})(this, function (_exports, _cast, _isLike, _reduce, _nice2, _enumerable) {
  "use strict";
