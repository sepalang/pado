export const IS_NULLIFY = function(data){
...
export const AS_ARRAY = function(data, defaultArray=undefined){
  if(IS_ARRAY(data)){
    return data;
  }
  if(IS_NULLIFY(data)){
...
export const IS_POSITIVE_PROP = function(value){
  if(value === true){
    return true;
  }
  if(value === false){
...
export const IS_NEGATIVE_PROP = value=>!IS_POSITIVE_PROP(value)
...
export const REFRESH_DATA = function(oldData,newData,getId,afterHook){
...
export const HAS_VALUE = (function(){
...
export const GET_KEY_BY = function(object,value){
...
export const STRING_CAST = (function(){
...
*/
export const FIND_INDEXES = (function(){
...
export const EACH_PROC = function(arr,proc){
    if(arr.length > 1){
...
export const STATIC_FOR_EACH_PROC = function(obj,proc){
...
export const REMOVE_VALUE = function(obj,value){
  var detect = true;
...
export const CLEAR_OF = function(data,fillFn,sp){
...
export const INSERT_OF = function(data,v,a){
  IS_ARRAY(data) && data.splice(typeof a === "number"?a:0,0,v)
  return data;
}

export const MOVE_OF = function(data,oldIndex,newIndex){
...
export const CONCAT_OF = function(data,appends){
  var data = AS_ARRAY(data);
  return EACH(appends,function(value){ data.push(value); }), data;
}


export const FILTER_OF = function(data,func,exitFn){
  var data    = AS_ARRAY(data);
  var exitCnt = 0;
...
export const SORT_OF = function(data,filter){
  if(data.length == 0){
    return data;
  }
...
export const NESTED_HAS_PROC = function(obj,key){
  var keys = key.split(".");
...
export const DIFF_STRUCTURE = function(before,after){
